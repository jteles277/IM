...
from gmail.gmail_class import classify_email, archive_email, delete_email
...
class ClassifyEmail(Resource): 
    def post(self):
        try:
            ...
            label_name = str(request.args.get("label_name", "Label_4152429321432184239"))
            service = get_gmail_service()
...
#api.add_resource(ArchiveEmail, "/archive-email")
api.add_resource(DeleteEmail, "/delete-email")
